...
return [
    ...
    */
    ...
    'android' => [
        ...
        */
        'theme' => [
            'color_primary' => env('NATIVEPHP_ANDROID_COLOR_PRIMARY', '#782BF1'),
            'color_primary_night' => env('NATIVEPHP_ANDROID_COLOR_PRIMARY_NIGHT', '#782BF1'),
    ...
    */
    ...
    'server' => [
        ...
        'http_port' => env('NATIVEPHP_HTTP_PORT', 3_000),

        // WebSocket server port for hot reload communication
        'ws_port' => env('NATIVEPHP_WS_PORT', 8_081),
