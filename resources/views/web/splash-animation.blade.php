...
<head>
    ...
    <style>
        ...
        .he4rt-logo .trace {
            fill: none;
            stroke: color-mix(in srgb, #782BF1 22%, transparent);
            stroke-width: 3;
        }
        .he4rt-logo .led {
            fill: none;
            ...
            filter: drop-shadow(0 0 9px rgba(120, 43, 241, 0.95));
            stroke-dasharray: 16 84;
            animation: he4rt-led-run 2.6s linear infinite;
        }
        .he4rt-logo .led.b {
            animation-delay: 1.3s;
        }
        @keyframes he4rt-led-run {
            from {
...
<body>
    <div class="he4rt-logo" aria-hidden="true">
